...
public:
    ...
    bool unlock_pos(const SecureString& wallet_passphrase) override { return m_wallet.Unlock(wallet_passphrase, true); }
    bool isLocked() override { return m_wallet.IsLocked(false); }
    bool isLocked_pos() override { return m_wallet.IsLocked(true); }

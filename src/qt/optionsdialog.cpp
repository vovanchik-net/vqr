    ...
    mapper(0)
{
    ...
    ui->prune->setVisible(false);
    ui->pruneSize->setVisible(false);
    ui->pruneSizeUnitLabel->setVisible(false);
    ui->threadsScriptVerifLabel->setVisible(false);
    ui->threadsScriptVerif->setVisible(false);
    ...
    ui->proxyActiveNets->setVisible(false);
    ui->proxyReachIPv4->setVisible(false);
    ui->proxyReachIPv4Label->setVisible(false);
    ui->proxyReachIPv6->setVisible(false);
    ui->proxyReachIPv6Label->setVisible(false);
    ui->proxyReachTor->setVisible(false);
    ui->proxyReachTorLabel->setVisible(false);
    ui->connectSocksTor->setVisible(false);
    ui->proxyIpTorLabel->setVisible(false);
    ui->proxyIpTor->setVisible(false);
    ui->proxyPortTorLabel->setVisible(false);
    ui->proxyPortTor->setVisible(false);

...
{
    QMetaObject::invokeMethod(clientmodel, "masternodeListChanged", Qt::QueuedConnection);
}

static void NotifyAdditionalDataSyncProgressChanged(ClientModel *clientmodel, int nSyncProgress)
{
